...
if __name__=='__main__':
  ...
  parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/tm/mesh/tm.ply')
  ...
  for index in range(1,580):
    ...
    if i == 1 :
      pose = np.array([[ 0.75435163,  0.65530636, -0.03907921 ,-0.03107189],
                      [-0.3104555 ,  0.30366068 ,-0.90078164 ,-0.03163758],
                      [-0.57842112  ,0.69163846,  0.4325104,   0.42023163],
                       [0., 0., 0., 1.0]     ])
