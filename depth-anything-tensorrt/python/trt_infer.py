...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', type=str,  default='/home/sunh/6D_ws/Fpose_rgb/demo_data/bj/rgb/000081-color.png',required=False, help='Path to the input image')
    parser.add_argument('--outdir', type=str, default='./vis_depth', help='Output directory for the depth map')
    parser.add_argument('--engine', type=str,  default='/home/sunh/6D_ws/Fpose_rgb/feature2/depth_anything_v2_vitb.engine',required=False, help='Path to the TensorRT engine')
